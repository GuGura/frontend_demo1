    ...
    <form>
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="email" class="form-control" id="email" placeholder="이메일를 입력하세요." name="email"
               v-model="result.email" readonly="readonly">
      </div>
      <div class="mb-3">
      ...
      <div class="d-flex">
        <div class="p-2 d-flex-fill" v-if="result.gender">
          <div class="form-check">
            <input type="radio" class="form-check-input" id="radio1" name="optradio" v-bind:value="true" checked
                   v-model="result.gender">
            <label class="form-check-label" for="radio1">남성</label>
          </div>
        </div>

        <div class="p-2 d-flex-fill" v-else>
          <div class="form-check">
            <input type="radio" class="form-check-input" id="radio2" name="optradio" v-bind:value="false" checked
                   v-model="result.gender">
